...
export class Migration20250714143511 extends Migration {
	override async up(): Promise<void> {
		this.addSql(
			`create table if not exists "offer" ("id" text not null, "offer_number" text not null, "title" text not null, "description" text null, "status" text not null default 'draft', "customer_name" text null, "customer_email" text null, "customer_phone" text null, "customer_address" text null, "subtotal" integer not null default 0, "tax_amount" integer not null default 0, "discount_amount" integer not null default 0, "total_amount" integer not null default 0, "currency_code" text not null default 'EUR', "valid_until" timestamptz null, "accepted_at" timestamptz null, "completed_at" timestamptz null, "cancelled_at" timestamptz null, "internal_notes" text null, "customer_notes" text null, "pdf_url" text null, "created_by" text null, "assigned_to" text null, "requires_approval" boolean not null default false, "is_template" boolean not null default false, "template_name" text null, "has_reservations" boolean not null default false, "reservation_expires_at" timestamptz null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "offer_pkey" primary key ("id"));`,
		);
		this.addSql(

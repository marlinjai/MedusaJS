...
export class Migration20250704000000 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(`ALTER TABLE "offer" ADD COLUMN IF NOT EXISTS "deleted_at" timestamptz NULL;`);
    this.addSql(`ALTER TABLE "offer_item" ADD COLUMN IF NOT EXISTS "deleted_at" timestamptz NULL;`);
    this.addSql(`ALTER TABLE "offer_status_history" ADD COLUMN IF NOT EXISTS "deleted_at" timestamptz NULL;`);
  ...
  async down(): Promise<void> {
    ...
    this.addSql(`ALTER TABLE "offer_status_history" DROP COLUMN IF EXISTS "deleted_at";`);
  }
}

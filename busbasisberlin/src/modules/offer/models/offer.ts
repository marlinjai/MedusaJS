...
const offer = model.define('offer', {
  ...
  offer_number_seq: model.number().unique(), // Auto-incrementing sequence for Angebotsnummer (handled in service)
  offer_number: model.text(), // Formatted offer number (e.g., "ANG-00001")

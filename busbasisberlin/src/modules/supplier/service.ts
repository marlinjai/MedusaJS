...
class SupplierService extends MedusaService({
	 ...
	 */
	async getGroupedSuppliersForProduct(
		productId: string,
	): Promise<GroupedSupplierRelationship[]> {
	 ...
	 */
	async deleteProductSupplierRelationship(
		relationshipId: string,
	): Promise<void> {
	 ...
	 */
	async reorderSupplierRelationships(
		productId: string,
		supplierId: string,
	 ...
	 */
	async getPrimarySupplierForProduct(
		productId: string,

      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <Section title="Persönliche Informationen">
          <div>
            ...
            <Input name="salutation" value={form.salutation || ''} onChange={handleChange} placeholder="Herr/Frau" />
          </div>
          <div>
            <Text size="small" weight="plus" className="text-ui-fg-base mb-2">
              Titel
            </Text>
            <Input name="title" value={form.title || ''} onChange={handleChange} placeholder="Dr., Prof., etc." />
          </div>
          <div>
            <Text size="small" weight="plus" className="text-ui-fg-base mb-2">
        ...
        <Section title="Kontaktinformationen">
          ...
          <div>
            ...
            <Input name="phone" value={form.phone || ''} onChange={handleChange} placeholder="+49 30 12345678" />
          </div>
          <div>
            <Text size="small" weight="plus" className="text-ui-fg-base mb-2">
              Fax
            </Text>
            <Input name="fax" value={form.fax || ''} onChange={handleChange} placeholder="+49 30 12345679" />
          </div>
          <div>
            <Text size="small" weight="plus" className="text-ui-fg-base mb-2">
              Mobil
            </Text>
            <Input name="mobile" value={form.mobile || ''} onChange={handleChange} placeholder="+49 170 1234567" />
          </div>
          <div>
            <Text size="small" weight="plus" className="text-ui-fg-base mb-2">
              Webseite
        ...
        <Section title="Adresse">
          <div>
            ...
            <Input name="street" value={form.street || ''} onChange={handleChange} placeholder="Musterstraße" />
          </div>
          <div>
            <Text size="small" weight="plus" className="text-ui-fg-base mb-2">
              Adresszusatz
          ...
          <div>
            ...
            <Input name="street_number" value={form.street_number || ''} onChange={handleChange} placeholder="123a" />
          </div>
          <div>
            <Text size="small" weight="plus" className="text-ui-fg-base mb-2">
              PLZ
            </Text>
            <Input name="postal_code" value={form.postal_code || ''} onChange={handleChange} placeholder="12345" />
          </div>
          <div>
            <Text size="small" weight="plus" className="text-ui-fg-base mb-2">
              Stadt
            </Text>
            <Input name="city" value={form.city || ''} onChange={handleChange} placeholder="Berlin" />
          </div>
          <div>
            <Text size="small" weight="plus" className="text-ui-fg-base mb-2">
              Land
            </Text>
            <Input name="country" value={form.country || ''} onChange={handleChange} placeholder="Deutschland" />
          </div>
          <div>
            <Text size="small" weight="plus" className="text-ui-fg-base mb-2">
              Bundesland
            </Text>
            <Input name="state" value={form.state || ''} onChange={handleChange} placeholder="Berlin" />
          </div>
        </Section>
        ...
        <Section title="Geschäftliche Informationen">
          <div>
            ...
            <Input name="vat_id" value={form.vat_id || ''} onChange={handleChange} placeholder="DE123456789" />
          </div>
          <div>
            <Text size="small" weight="plus" className="text-ui-fg-base mb-2">
              Steuernummer
        ...
        <Section title="Typ & Status">
          <div>
            ...
            <Select value={form.customer_type} onValueChange={v => handleSelect('customer_type', v)}>
        ...
        <Section title="Kontakt-Zeitstempel">
          ...
          <div>
            ...
            <Input name="last_contact_date" value={form.last_contact_date || ''} onChange={handleChange} type="date" />
          </div>
        </Section>

        {/* Submit */}
        <div className="flex justify-end gap-4">
          <Button type="button" variant="secondary" onClick={() => navigate('/manual-customers')}>
            Abbrechen
          </Button>

 ...
 */
export const PAGE_PADDING_TOP = 'pt-24 hero-alert-visible:pt-32';
...
export const PAGE_PADDING_TOP_LARGE =
	'pt-32 lg:pt-20 hero-alert-visible:pt-40 hero-alert-visible:lg:pt-44';

/**
 * Extra large padding for hero sections and special pages
 */
export const PAGE_PADDING_TOP_XLARGE = 'pt-40 hero-alert-visible:pt-48';
